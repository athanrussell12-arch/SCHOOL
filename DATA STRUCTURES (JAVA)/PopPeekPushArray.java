...
//BSIT-1A
//This JAVA Program operates the Push, Peek, and Pop Operation of stack using an array.



import java.util.Scanner;

public class PopPeekPushArray
{
	public static void main (String [] args)
	{
		...
		else
		{
			...
			System.out.print("Values After Popping: ");			//displays the remaining values
		...
		else
		{
			...
			System.out.println("Top Value is " + val1);			//display or print the top value
			}
		...
		else
		{
			...
			System.out.println("Top Value is " + val3);			//display or print the top value
			}
